...
SELECT 'test1@example.com', '$2a$10$c/pR2kwhJOWjvzy05fySB.tIorRRJ6r5ggxNSdxf4M/lkLenN3iiS', 'User1', 20, 0
    WHERE NOT EXISTS (
    SELECT 1 FROM member WHERE email = 'test1@example.com' AND nickname = 'User1'
);

INSERT INTO member (email, login_pw, nickname, age, role)
SELECT 'admin@example.com', '$2a$10$qiIizKopu6SydQUmNmXAbOd7mSNaGYkdntdBu5fQgdf7pUdPjLJIq', '관리자', 20, 1
    WHERE NOT EXISTS (
